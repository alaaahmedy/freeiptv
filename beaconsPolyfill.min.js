/*https://polyfill.io/v3/polyfill.min.js?features=Symbol.iterator%2CObject.entries%2CArray.prototype.flatMap%2CArray.prototype.indexOf%2CArray.prototype.find&flags=always,gated*/
(function(self, undefined) {
    ...
    function FlattenIntoArray(r, t, e, a, n) {
        for (var o = arguments[5], i = arguments[6], l = a, g = 0; g < e;) {
            ...
            if (!0 === HasProperty(t, h)) {
                ...
                var f = !1;
                if (n > 0 && (f = IsArray(y)), !0 === f) {
                    l = FlattenIntoArray(r, y, ToLength(Get(y, "length")), l, n - 1)
                } else {
    ...
    if (!("flatMap" in Array.prototype)) {
        CreateMethodProperty(Array.prototype, "flatMap", function e(r) {
            "use strict";
            var t = ToObject(this),
                a = ToLength(Get(t, "length"));
            if (!1 === IsCallable(r)) throw new TypeError("mapperFunction is not callable.");
            var n;
            n = 1 in arguments ? arguments[1] : undefined;
            var o = ArraySpeciesCreate(t, 0);
            return FlattenIntoArray(o, t, a, 0, 1, r, n), o
        });
    }
    ...
    if (!("getComputedStyle" in self)) {
        ! function(t) {
            ...
            function r(t) {
                ...
                for (r in i)
                    if (Array.prototype.push.call(n, "styleFloat" == r ? "float" : r.replace(/[A-Z]/, u)), "width" == r) n[r] = t.offsetWidth + "px";
    ...
    if (!("document" in self && "documentElement" in self.document && "style" in self.document.documentElement && "scrollBehavior" in document.documentElement.style || function() {
            try {
                var e = !1,
                    t = {
                        top: 0,
                ...
                return Object.defineProperty(t, "behavior", {
                    get: function() {
                        return e = !0, "smooth"
                    },
                    enumerable: !0
                }), document.body.scrollTo(t), e
            } catch (n) {
                return !1
            }
        }())) {
        ! function() {
            ...
            function n(e, t, n, o, r, i, a, c) {
                return i < e && a > t || i > e && a < t ? 0 : i <= e && c <= n || a >= t && c >= n ? i - e - o : a > t && c < n || i < e && c > n ? a - t + r : 0
            }
            var o, r, i, a, c, l = function() {
                    return l = Object.assign || function e(t) {
                ...
                f = function() {
                    return (performance && performance.now ? performance : Date).now()
                },
                s = function(e) {
                    var t = f(),
                        n = (t - e.timeStamp) / (e.duration || 500);
                    if (n > 1) return e.method(e.targetX, e.targetY), void e.callback();
                    var o = (e.timingFunc || u)(n),
                        r = e.startX + (e.targetX - e.startX) * o,
                        i = e.startY + (e.targetY - e.startY) * o;
                    e.method(r, i), e.rafId = requestAnimationFrame(function() {
                        s(e)
                    })
                },
                d = function() {
                    return o === undefined && (o = Element.prototype.scroll || Element.prototype.scrollTo || function(e, t) {
                ...
                w = function(e, t) {
                    ...
                    if (t.left !== undefined || t.top !== undefined) {
                        var o = e.scrollLeft,
                            ...
                            c = t.top,
                            l = void 0 === c ? r : c;
                        if ("smooth" !== t.behavior) return n(a, l);
                        var u = function() {
                                window.removeEventListener("wheel", p), window.removeEventListener("touchmove", p)
                            },
                            w = {
                                timeStamp: f(),
                                duration: t.duration,
                            ...
                            p = function() {
                                cancelAnimationFrame(w.rafId), u()
                            };
                ...
                p = function(e) {
                    var n = d();
                    Element.prototype.scroll = function o() {
                        var o = t(arguments, 2),
                            r = o[0],
                            i = void 0 === r ? 0 : r,
                            a = o[1],
                            c = void 0 === a ? 0 : a;
                        if ("number" == typeof i && "number" == typeof c) return n.call(this, i, c);
                        if (Object(i) !== i) throw new TypeError("Failed to execute 'scroll' on 'Element': parameter 1 ('options') is not an object.");
                        return w(this, l(l({}, i), e))
                    }
                },
                m = function(e, t) {
                    var n = (t.left || 0) + e.scrollLeft,
                        o = (t.top || 0) + e.scrollTop;
                    return w(e, l(l({}, t), {
                        left: n,
                        top: o
                    }))
                ...
                h = function(e) {
                    Element.prototype.scrollBy = function n() {
                        var n = t(arguments, 2),
                            o = n[0],
                            r = void 0 === o ? 0 : o,
                            i = n[1],
                            a = void 0 === i ? 0 : i;
                        if ("number" == typeof r && "number" == typeof a) return m(this, {
                            left: r,
                            top: a
                        });
                        if (Object(r) !== r) throw new TypeError("Failed to execute 'scrollBy' on 'Element': parameter 1 ('options') is not an object.");
                        return m(this, l(l({}, r), e))
                    }
                },
                v = function(e, t, n, o) {
                ...
                y = function(e) {
                    if (e.clientHeight < e.scrollHeight || e.clientWidth < e.scrollWidth) {
                        ...
                        return b(t.overflowY) || b(t.overflowX)
                    }
                    return !1
                },
                g = function(e) {
                ...
                E = function(t, o) {
                    var r, i;
                    if (t.ownerDocument.documentElement.contains(t)) {
                        for (var a = document.scrollingElement || document.documentElement, c = [], u = g(t); null !== u; u = g(u)) {
                            if (u === a) {
                                c.push(u);
                                break
                            }
                            u === document.body && y(u) && !y(document.documentElement) || y(u) && c.push(u)
                        }
                        var f = window.visualViewport ? window.visualViewport.width : innerWidth,
                            s = window.visualViewport ? window.visualViewport.height : innerHeight,
                            ...
                            F = j.writingMode || j.webkitWritingMode || j.getPropertyValue("-ms-writing-mode") || "horizontal-tb",
                            x = ["horizontal-tb", "lr", "lr-tb", "rl"].some(function(e) {
                                return e === F
                            }),
                            W = ["vertical-rl", "tb-rl"].some(function(e) {
                                return e === F
                            }),
                            X = v(o, 0, x, W),
                            Y = v(o, 1, x, W),
                            ...
                            M = [];
                        try {
                            for (var S = e(c), B = S.next(); !B.done; B = S.next()) {
                                var V = B.value;
                                ! function(e) {
                                    var t = e.getBoundingClientRect(),
                                        ...
                                        g = parseInt(y.borderLeftWidth, 10),
                                        E = parseInt(y.borderTopWidth, 10),
                                        T = parseInt(y.borderRightWidth, 10),
                                        O = parseInt(y.borderBottomWidth, 10),
                                        k = 0,
                                        j = 0,
                                        F = "offsetWidth" in e ? e.offsetWidth - e.clientWidth - g - T : 0,
                                        x = "offsetHeight" in e ? e.offsetHeight - e.clientHeight - E - O : 0;
                                    if (a === e) {
                                        switch (Y) {
                                            case 2:
                                                k = I;
                                        ...
                                        switch (X) {
                                            ...
                                            case 1:
                                                ...
                                                break;
                                            case 0:
                                                j = n(d, d + f, f, g, T, d + L, d + L + b, b)
                                        }
                                        k = Math.max(0, k + p), j = Math.max(0, j + d)
                                    } else {
                                        switch (Y) {
                                            case 2:
                                                k = I - c - E;
                                        ...
                                        switch (X) {
                                            ...
                                            case 1:
                                                ...
                                                break;
                                            case 0:
                                                j = n(v, u, i, g, T + F, L, L + b, b)
                                        }
                                        var W = e.scrollLeft,
                                            S = e.scrollTop;
                                        k = Math.max(0, Math.min(S + k, e.scrollHeight - r + x)), j = Math.max(0, Math.min(W + j, e.scrollWidth - i + F)), I += S - k, L += W - j
                                    }
                                    M.push(function() {
                                        return w(e, l(l({}, o), {
                                            top: k,
                ...
                T = function() {
                    return r === undefined && (r = document.documentElement.scrollIntoView), r
                },
                O = function(e) {
                    var t = T();
                    Element.prototype.scrollIntoView = function n(o) {
                        if ("boolean" == typeof o || o === undefined) return t.call(this, o);
                        if (Object(o) !== o) throw new TypeError("Failed to execute 'scrollIntoView' on 'Element': parameter 1 ('options') is not an object.");
                        return E(this, l(l({}, o), e))
                    }
                },
                k = function(e) {
                    var n = d();
                    Element.prototype.scrollTo = function o() {
                        var o = t(arguments, 2),
                            ...
                            c = void 0 === a ? 0 : a;
                        if ("number" == typeof i && "number" == typeof c) return n.call(this, i, c);
                        if (Object(i) !== i) throw new TypeError("Failed to execute 'scrollTo' on 'Element': parameter 1 ('options') is not an object.");
                        return w(this, l(l({}, i), e))
                    }
                },
                j = function() {
                    return i === undefined && (i = (window.scroll || window.scrollTo).bind(window)), i
                },
                F = function(e) {
                    var t = j();
                    if (e.left !== undefined || e.top !== undefined) {
                        var n = window.scrollX || window.pageXOffset,
                            ...
                            a = e.top,
                            c = void 0 === a ? o : a;
                        if ("smooth" !== e.behavior) return t(i, c);
                        var l = function() {
                                window.removeEventListener("wheel", d), window.removeEventListener("touchmove", d)
                            },
                            u = {
                                timeStamp: f(),
                                duration: e.duration,
                ...
                x = function(e) {
                    ...
                    window.scroll = function o() {
                        var o = t(arguments, 2),
                            ...
                            c = void 0 === a ? 0 : a;
                        if ("number" == typeof i && "number" == typeof c) return n.call(this, i, c);
                        if (Object(i) !== i) throw new TypeError("Failed to execute 'scroll' on 'Window': parameter 1 ('options') is not an object.");
                        return F(l(l({}, i), e))
                    }
                },
                W = function(e) {
                    var t = (e.left || 0) + (window.scrollX || window.pageXOffset),
                        n = (e.top || 0) + (window.scrollY || window.pageYOffset);
                    return "smooth" !== e.behavior ? j()(t, n) : F(l(l({}, e), {
                        left: t,
                        top: n
                    }))
                },
                X = function(e) {
                    var n = function() {
                        return a === undefined && (a = window.scrollBy.bind(window)), a
                    }();
                    window.scrollBy = function o() {
                        var o = t(arguments, 2),
                            ...
                            c = void 0 === a ? 0 : a;
                        if ("number" == typeof i && "number" == typeof c) return n.call(this, i, c);
                        if (Object(i) !== i) throw new TypeError("Failed to execute 'scrollBy' on 'Window': parameter 1 ('options') is not an object.");
                        return W(l(l({}, i), e))
                    }
                },
                Y = function() {
                    return c === undefined && (c = (window.scrollTo || window.scroll).bind(window)), c
                },
                I = function(e) {
                    var n = Y();
                    window.scrollTo = function o() {
                        var o = t(arguments, 2),
                            ...
                            c = void 0 === a ? 0 : a;
                        if ("number" == typeof i && "number" == typeof c) return n.call(this, i, c);
                        if (Object(i) !== i) throw new TypeError("Failed to execute 'scrollTo' on 'Window': parameter 1 ('options') is not an object.");
                        return F(l(l({}, i), e))
                    }
                };
            ! function(e) {
                "scrollBehavior" in document.documentElement.style || (x(e), I(e), X(e), p(e), k(e), h(e), O(e))
            }()
        }();
    }
